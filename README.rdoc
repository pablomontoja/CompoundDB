...
CompoundDB is a very simple Ruby on Rails application used to store information about chemicals in laboratory.
...
in Ubuntu: sudo apt-get install openbabel

== INSTALLATION (example in Ubuntu Server 15.10)
...
## Installation of Ruby on Rails has been omitted. ##
